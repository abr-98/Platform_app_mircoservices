from ParticipantServices.Core.ParticipantException import *
...
class ErrorCodeHandler:
    ...
    def init_cases(self):
        self.switcher={
            ParticipantAlreadyExists: self.return_error_and_Code(self.ex, 405),
            ParticipantDoesNotExist: self.return_error_and_Code(self.ex, 404),
            ParticipantIsBlocked: self.return_error_and_Code(self.ex, 405),
